    ...
    <section class="u-align-left u-clearfix u-image u-shading u-section-2" id="carousel_714f">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        @if(Session::has('notice'))
          <p class="u-text-body-color"> <strong> {{ Session::get('notice') }} </strong> </p>
        @endif
        @if(count($errors) > 0)
          <div class="alert alert-danger" role="alert">
            <ul>
              @foreach($errors->all() as $error)
                <li class="u-text-body-color">{{ $error }}</li>
              @endforeach
            </ul>
          </div>
        @endif
          <!-- Formulario -->
          <form method="POST" action="/account" class="u-clearfix u-form-spacing-30  u-inner-form" style="padding: 10px" source="custom" name="form">
            @csrf
            <div class="u-form-group u-form-name">
              <label for="name-f997" class="u-label u-text-body-color">Nombre de Usuario</label>
              <input type="text" placeholder="Introduzca un nombre de usuario" id="name-f998" name="user_name" class="u-border-1 u-border-black u-input u-input-rectangle u-text-body-color" pattern="^[A-ZÁÉÍÓÚ]{1}[a-zA-ZÁÉÍÓÚñáéíóú0-9_'-.@#$|]+( [a-zA-ZÁÉÍÓÚñáéíóú0-9_'-.@#$|]+)*$" minlength="4" maxlength="50" required>
            </div>
            </br>
            <div class="u-form-group u-form-name">
            ...
            <div class="u-form-group">
              ...
              <input type="text" placeholder="Introduzca su primer apellido" id="lastname-f997" name="lastname" class="u-border-1 u-border-black u-input u-input-rectangle u-text-body-color" pattern="[A-ZÁÉÍÓÚ]{1}[a-zñáéíóú][^0-9_!¡?÷?¿/\\+=@#$%ˆ&*(){}|~<>;:[\]]{2,}" maxlength="25" required>
            </div>
            </br>
            ...
            <div class="u-form-group u-form-phone u-form-group-5">
              ...
              <input type="tel" pattern="[0-9]{2}-?[0-9]{4}-?[0-9]{4}" placeholder="Ingrese su teléfono (e.j. 33-3540-3020)" id="tel-760e" name="telephone" class="u-border-1 u-border-black u-input u-input-rectangle u-text-body-color" minlength="10" maxlength="12" required>
            </div> 
            </br>
