...
<html style="font-size: 16px;" lang="es-MX">
  <head>
    ...
    <title>HotelAdmin - Habitaciones</title>
    ...
    <section class="ftco-section">
      ...
      @if(Session::has('notice'))
        ...
        <div class="row">
          <div class="col-md-12">
          <div>
            <h4 style="color: darkblue; text-align:center;">INFORMACIÓN GENERAL DE LAS HABITACIONES</h4>
            ...
            <div class="table-wrap">
              ...
              @else
                <p> No se han encontrado habitaciones </p>
              @endif
            </div>
          </div>
        </div>
