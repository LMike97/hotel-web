...
<html style="font-size: 16px;" lang="es-MX">
  ...
  @if($perfil != null && $empleado != null)
  @foreach($empleado as $item)
  <div class="container bootstrap snippet">
    <div class="row">
      <div class="col-sm-3"><!--left col-->
      <form class="form" action="/profile_employee{{($perfil == null) ?'': "/$perfil->id"}}" method="POST" enctype="multipart/form-data" id="registrationForm">
            @csrf
            @if($modo == 'editar')
              @method('PUT')
            @endif
        ...
        <div class="tab-content">
          ...
          <label for="user_name"><h4>Menú de Edición</h4></label>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="col-xs-6">
                  <label for="direction"><h4>Dirección</h4></label>
                  <input type="text" class="form-control" id="direction" name="direction" placeholder="Ingrese la dirección de su domicilio" value = "{{($item == null) ?'': $item->direction}}" required="">
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12">
                  ...
                  <button class="btn btn-lg" href="/profile_employee/{{$perfil->id}}"><i class="glyphicon glyphicon-repeat"></i>Cancelar</button>
                </div>
              </div>
          	</form>
          </div>
    ...
    @endforeach
    @else
    <meta http-equiv="refresh" content="0; url=/profile_employee/{{$user->id}}/edit">
    @endif
