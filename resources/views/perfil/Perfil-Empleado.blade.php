    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        <div class="tab-content">
          ...
          @endif
            <hr>
            <form class="form" action="/profile_employee/{{$perfil->id}}/edit" method="GET" id="registrationForm">
              @csrf
              ...
              <div class="form-group">
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" name="direction" id="direction" readonly="readonly" value = "{{($item == null) ?'': $item->direction}}">
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-6">
                  <label for="position"><h4>Puesto</h4></label>
                  <input type="text" class="form-control" name="position" id="position" placeholder="Sin descuento" readonly="readonly" value = "{{($item == null) ?'': $item->position}}">
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12">
