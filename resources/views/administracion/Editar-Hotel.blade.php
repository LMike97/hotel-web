            ...
            <div class="u-layout-row">
              <div class="u-container-style u-grey-80 u-layout-cell u-size-13 u-layout-cell-1">
                <div class="u-border-2 u-border-grey-50 u-container-layout u-container-layout-1">
                  ...
                  <a href="/Mostrar_Hotel" class="u-align-center u-btn u-button-style u-hover-palette-1-dark-3 u-palette-1-dark-2 u-btn-3">Mostrar</a>
              ...
              <div class="u-container-style u-layout-cell u-size-44 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <div class="u-form u-form-1">
                    <h3 style="text-align: center; color: #00B8FF;">EDITAR UN HOTEL</h3>
                    <h4 style="text-align: center; color: #484848;">INGRESE EL ID DEL HOTEL QUE DESEA BUSCAR</h4>
                    <!-- FORMULARIO -->
                    <form action="/edit-hotel" method="GET" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
                        @csrf
                        <div class="u-form-group u-form-name u-form-group-1">
                          <!-- ID -->
                          <label for="name-6797" class="u-label u-text-grey-70">HOTEL ID</label>
                          <input type="text" placeholder="ID del hotel que desea editar" id="ID" name="ID" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" pattern="[1-9]{1}[0-9]*" required="">
                        </div>
                        </br>
                    ...
                    <p style="text-align: center; color: #6D6D6D;">Si desconoce las identificaciones de los hoteles (ID), puede dirigirse a la sección 'listar' dentro del menú/submenú
                      'Hoteles'. Dentro de esta sección se despliega la información adecuada para proseguir con la operación.</p>
                  </div>
                </div>
              </div>
            </div>
