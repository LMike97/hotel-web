              ...
              <div class="u-container-style u-layout-cell u-size-44 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <div class="u-form u-form-1">
                    <h3 style="text-align: center; color: #00B8FF;">EDITAR UN EMPLEADO</h3>
                    <h4 style="text-align: center; color: #484848;">INGRESE EL ID DEL EMPLEADO QUE DESEA BUSCAR</h4>
                    <!-- FORMULARIO -->
                    <form action="/edit-employee" method="GET" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
                        @csrf
                        <div class="u-form-group u-form-name u-form-group-1">
                          <!-- ID -->
                          <label for="name-6797" class="u-label u-text-grey-70">EMPLEADO ID</label>
                          <input type="text" placeholder="ID del empleado que desea editar" id="ID" name="ID" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" pattern="[1-9]{1}[0-9]*" required="">
                        </div>
                        </br>
