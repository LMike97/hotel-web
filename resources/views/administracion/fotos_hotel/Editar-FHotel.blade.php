...
<html style="font-size: 16px;" lang="es-MX">
  <head>
    ...
    <title>HotelAdmin - Buscar Hotel</title>
            ...
            <div class="u-layout-row">
              <div class="u-container-style u-grey-80 u-layout-cell u-size-13 u-layout-cell-1">
                <div class="u-border-2 u-border-grey-50 u-container-layout u-container-layout-1">
                  ...
                  <a href="/Mostrar_FHotel" class="u-align-center u-btn u-button-style u-hover-palette-1-dark-3 u-palette-1-dark-2 u-btn-3">Mostrar</a>
              ...
              <div class="u-container-style u-layout-cell u-size-44 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  <div class="u-form u-form-1">
                    <h3 style="text-align: center; color: #00B8FF;">EDITAR UN FOTO DEL HOTEL</h3>
                    <h4 style="text-align: center; color: #484848;">INGRESE EL ID DE LA FOTOGRAFÍA QUE DESEA BUSCAR</h4>
                    <!-- FORMULARIO -->
                    <form action="/edit-fHotel" method="GET" class="u-clearfix u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom" name="form">
                        @csrf
                    ...
                    <p style="text-align: center; color: #6D6D6D;">Si desconoce las identificaciones de las fotos (ID), puede dirigirse a la sección 'listar' dentro del menú/submenú
                      'Imagenes' en el apartado 'Hoteles'. Dentro de esta sección se despliega la información adecuada para proseguir con la operación.</p>
                  </div>
                </div>
              </div>
            </div>
